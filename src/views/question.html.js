...
<ul class="answerList">
  ...
  <li class="${ANSWER_ITEM}">
    ...
    <input class="${ANSWER_INPUT}" type="radio" id="${answers[1].key}" name="answer" />
  ...
  <li class="${ANSWER_ITEM}">
    ...
    <input class="${ANSWER_INPUT}" type="radio" id="${answers[2].key}" name="answer" />
  ...
  <li class="${ANSWER_ITEM}">
    <input class="${ANSWER_INPUT}" type="radio" id="${answers[3].key}" name="answer" />
...
<a class=" btn btn-block btn-dark btn-block" id=${NEXT_QUESTION_BUTTON_ID} href="?page=${pathname}">Next question</a>
